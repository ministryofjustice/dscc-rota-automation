...
public class ColumnWindowController implements Initializable {
    ...
    public void getData(LocalDate start, LocalDate end, ArrayList<Scheme> listSchemes, MainWindowController MWC) {
    ...
    private void patternBox() {
        ...
        recurrenceType.addAll("Blank", "Every week", "Every 2 weeks starting 1st week", "Every 2 weeks starting 2nd week");
