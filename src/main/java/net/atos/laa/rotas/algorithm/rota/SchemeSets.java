...
public class SchemeSets {
  ...
  private final HashMap<Integer, ArrayList<Solicitor>> firms;
  private final HashMap<Integer, ArrayList<Solicitor>> schemeMembers;
  private final HashMap<Integer, Integer> noSolsinFirms;

  public ArrayList<Integer> getFirmIDs() {
    return firmIDs;
  }

  private final ArrayList<Integer> firmIDs;
  private final ArrayList<Integer> schemeIDs;
  private int solIndex;
  private int allocs;
  private final int totalSols;
  private final int adjacentCols;
  ...
  private final HashMap<Integer, Integer> allocations;

  public SchemeSets(ArrayList<Solicitor> solicitors, HashMap<Integer, Integer> allocations,
      ColumnType type, int adjacentCols) {
