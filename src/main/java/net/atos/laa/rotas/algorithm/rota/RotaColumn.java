...
/**
 * A data structure representing a single column in the rota. It maintains a list of slots as long
 * as the rota, which reference solicitors assigned to them
 */
public class RotaColumn {

  private final ColumnType type;
  private final String title;
  private final RotaSlot[] slots;
