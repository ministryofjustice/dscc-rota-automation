...
/**
 * A data structure representing a single slot in the rota. Each
 * slot references the solicitor assigned to it. If a slot is blank
 * it means that a solicitor will not be assigned to it
 */
