...
public class Rota {
    ...
    private LinkedHashMap<LocalDate, Integer> dateList;
    private ArrayList<RotaColumn> columnList;
    private int length;
    private RotaStats stats;
     ...
     * @param columnTemplates A list of <code>ColumnTemplate</code>s the
     *                        indicate the columns that the rota should have
     */
    ...
    /**
     * Converts each column template into an actual column in the rota,
     * with cells, and applies the blank slots to it
     *
